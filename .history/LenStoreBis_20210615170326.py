...
for job in jobs:
    ...
    lienAchatLenStore = "https://www.lenstore.fr/" + job.h3.a['href']
    jobs_no += 1
    npo_jobs[jobs_no] = [marque, nom_Produit,
                         id, lienAchatLenStore]
...
df['LenStore30'] = df['LenStore30'].str.strip()
df['LenStore30'] = df['LenStore30'].str.slice(start=-5)
