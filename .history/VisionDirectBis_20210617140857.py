...
for job in jobs:
    ...
    if (nom_Produit.find('1-Day Acuvue Moist') != -1):
        ...
        marque = "Acuvue"
    elif (nom_Produit.find('Biomedics') != -1 and nom_Produit.find('12,99') != -1):
        marque = "Biomedics"
...
#Clean le LMC30
df4['LMC30'] = df4['LMC30'].str.replace("€", "")
df4['LMC30'] = df4['LMC30'].str.strip()
df4['LMC30'] = df4['LMC30'].str.slice(start=-5)
