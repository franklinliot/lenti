...
for job in jobs:
    ...
    if (nom_Produit.find('(30)') != -1):
        ...
        nom_Produit = str.replace(nom_Produit, " 30", "")
    elif (nom_Produit.find('(180)') != -1):
        nom_Produit = str.replace(nom_Produit, " (180)", "")
    elif (nom_Produit.find('(90)') != -1):
        nom_Produit = str.replace(nom_Produit, " (90)", "")
...
df.to_csv(r'/home/franklin/coding/lenti/data/LentMCheres/LentillesMoinsCheres.csv')
