...
df3 = pd.DataFrame.from_dict(npo_jobs, orient='index', columns=[
    'marque', 'nom_Produit', 'MaLentille30', 'lienAchatMaLentille'])

#Clean le MaLentille30
df3['MaLentille30'] = df3['MaLentille30'].str.replace("€", "")
df3['MaLentille30'] = df3['MaLentille30'].str.strip()
df3['MaLentille30'] = df3['MaLentille30'].str.slice(start=-5)
...
df3['MaLentille30'] = df3.apply(lambda x: make_clickable(
    x['lienAchatMaLentille'], x['MaLentille30']), axis=1)

# Cache la colonne lienAchatMaLentille
df3 = df3[['marque', 'nom_Produit', 'MaLentille30']]
