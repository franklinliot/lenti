...
for job in jobs:
    ...
    nom_Produit = nomProduit.text.replace("1 Day", "1-Day").replace("MOIST", "Moist").replace("OASYS", "Oasys").replace(nom_Produit, "DAILIES", "Dailies").replace(nom_Produit, "ACUVUE", "Acuvue").strip()
