...
df4 = pd.DataFrame.from_dict(npo_jobs, orient='index', columns=[
    'marque', 'nom_Produit', 'MaLentille30', 'lienAchatVisionDirect'])

#Clean le MaLentille30
df4['MaLentille30'] = df4['MaLentille30'].str.replace("€", "")
df4['MaLentille30'] = df4['MaLentille30'].str.strip()
df4['MaLentille30'] = df4['MaLentille30'].str.slice(start=-5)
...
df4['MaLentille30'] = df4.apply(lambda x: make_clickable(
    x['lienAchatVisionDirect'], x['MaLentille30']), axis=1)

# Cache la colonne lienAchatVisionDirect
df4 = df4[['marque', 'nom_Produit', 'MaLentille30']]
...
df4.to_csv(r'data/VisionDirect/VisionDirect.csv')
